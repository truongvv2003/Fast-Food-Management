...
public class PanelDatDoAn_DatMon extends JPanel {
...
//					BillBLL.getInstance().deleteBill();
	...
	private void btn_order_Click() {
		nutpanelThemMon.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				// TODO Auto-generated method stub
				int idUser = UserBLL.getInstance().getIdUser(ManHinhChinh.taiKhoanAdmin, ManHinhChinh.matKhauAdmin).getId();;
				int idFood = 0;
