...
public class PanelTaiKhoan_ThongTin extends JPanel {
...
//		}
	...
	private void docDuLieu() {
		...
		jTextField_HoVaTen.setText(EmployeeBLL.getInstance().dsNhanVien(ManHinhChinh.taiKhoanAdmin, ManHinhChinh.matKhauAdmin).get(1));
			jTextField_GioiTinh.setText(EmployeeBLL.getInstance().dsNhanVien(ManHinhChinh.taiKhoanAdmin, ManHinhChinh.matKhauAdmin).get(3));
		
		jTextField_NgaySinh.setText(EmployeeBLL.getInstance().dsNhanVien(ManHinhChinh.taiKhoanAdmin, ManHinhChinh.matKhauAdmin).get(4));
		textField_MaNhanVien.setText(EmployeeBLL.getInstance().dsNhanVien(ManHinhChinh.taiKhoanAdmin, ManHinhChinh.matKhauAdmin).get(0));
		textField_ChucVu.setText(EmployeeBLL.getInstance().dsNhanVien(ManHinhChinh.taiKhoanAdmin, ManHinhChinh.matKhauAdmin).get(7));
		textField_SoDienThoai.setText(EmployeeBLL.getInstance().dsNhanVien(ManHinhChinh.taiKhoanAdmin, ManHinhChinh.matKhauAdmin).get(2));
		...
		this.nutpanelLuu.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(textField_SoDienThoai.getText().replaceAll(" ", "").equals("") == true) {
					...
					EmployeeBLL.getInstance().UpdateNhanVien(Integer.parseInt(EmployeeBLL.getInstance().dsNhanVien(ManHinhChinh.taiKhoanAdmin, ManHinhChinh.matKhauAdmin).get(0)) , textField_SoDienThoai.getText());
