...
public class PanelTaiKhoan_DoiMatKhau_NV extends JPanel {
	...
	public PanelTaiKhoan_DoiMatKhau_NV() {
	...
	private void caiDatPanelXepLichThi_ThoiGianThi() {
        ...
        lblMatKhauCu.setFont(new Font("Arial", Font.BOLD, 15));
        lblMatKhauCu.setHorizontalAlignment(SwingConstants.RIGHT);
        lblMatKhauCu.setBounds(226, 117, 155, 24);
        ...
        lblMatKhauMoi.setFont(new Font("Arial", Font.BOLD, 15));
        lblMatKhauMoi.setBounds(226, 162, 155, 24);
        ...
        lblNhapLaiMatKhau.setFont(new Font("Arial", Font.BOLD, 15));
        lblNhapLaiMatKhau.setBounds(226, 206, 155, 24);
        ...
        jTextField_MatKhauCu.setBounds(446, 118, 210, 24);
        ...
        jTextField_MatKhauMoi.setBounds(446, 162, 210, 24);
        ...
        jTextField_NhapLaiMatKhau.setBounds(446, 206, 210, 24);
		...
		nutpanelLuu.addMouseListener(new SuKienPanelTaiKhoan_DoiMatKhau_NV(this));
